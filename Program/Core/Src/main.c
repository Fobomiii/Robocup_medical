...
/* Definitions for canHostTask */
osThreadId_t canHostTaskHandle;
const osThreadAttr_t canHostTask_attributes = {
  .name = "canHostTask",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for OPSUartTask */
osThreadId_t OPSUartTaskHandle;
const osThreadAttr_t OPSUartTask_attributes = {
  .name = "OPSUartTask",
  .stack_size = 1024 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
void StartOPSUartTask(void *argument);
...
int main(void)
{
  ...
  /* creation of canHostTask */
  canHostTaskHandle = osThreadNew(StartCanHostTask, NULL, &canHostTask_attributes);

  /* creation of OPSUartTask */
  OPSUartTaskHandle = osThreadNew(StartOPSUartTask, NULL, &OPSUartTask_attributes);
...
static void MX_FDCAN2_Init(void)
{
  ...
  /* Keep FDCAN2 message RAM separate from the FDCAN1 allocation. */
...
/* USER CODE BEGIN Header_StartCanHostTask */
/**
  * @brief Function implementing the canHostTask thread.
  * @param argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartCanHostTask */
void StartCanHostTask(void *argument)
{
...
/* USER CODE BEGIN Header_StartOPSUartTask */
/**
  * @brief Function implementing the OPSUartTask thread.
  * @param argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartOPSUartTask */
void StartOPSUartTask(void *argument)
{
  /* USER CODE BEGIN StartOPSUartTask */
  (void)argument;
  OPS_Task(); /* 内部 OPS_Init + 周期读取维护，永不返回 */
  /* USER CODE END StartOPSUartTask */
}
